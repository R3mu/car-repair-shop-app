		...
		<vue-grid>
			<vue-grid-row>
				<vue-grid-item class="vueGridItem">
					...
					<a
							:class="$style.github"
							href="https://github.com/R3mu/car-repair-shop-app"
							target="_blank"
							rel="noopener"
							aria-label="github repository R3mu"
					>
						<vue-icon-github/>
					</a>
					<a
							:class="$style.github"
							href="https://github.com/pawelpotaczala/car-repair-shop-api"
							target="_blank"
							rel="noopener"
							aria-label="github repository pawelpotaczala"
					>
						<vue-icon-github/>
					</a>
					<br>
